...
export const ThankYouModal: FC<ThankYouModalProps> = ({
    show, duration = 1000
}) => {
    if (!show) return null;
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 
            ...
            <div className="bg-gradient-to-br from-indigo-300 via-purple-700 to-blue-800
                ...
                <p className="text-xl text-white text-center drop-shadow-md">
                    Мы надеемся, вам понравились шашки! Вы будете перенаправлены на наш блог о веб-разработке через {duration / 1000} секунд…
                </p>
