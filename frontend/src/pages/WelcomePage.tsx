...
export const WelcomePage = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-400 via-blue-500 to-indigo-600 px-4">
      <img src="/images/draughts.webp" alt="Шашки" className="max-w-[300px] w-full" />
      <p className="text-2xl md:text-3xl font-bold text-white -mt-2 mb-10 text-center">Шашки онлайн</p>
